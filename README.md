...
Te reason for sharing this Ansible Playbook is that setting up Mahout is not straightforward, and information on the internet is mostly not easy to follow. The goal here is to have a single easy to use tool to setup the environment.
